...
export default function EnhancedFilterPanel({
  ...
  const handleArrayToggle = (array: string[], item: string, field: string) => {
    ...
    setFilters((prev: typeof filters) => ({ ...prev, [field]: newArray }));
  };
      ...
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <div>
            ...
            <CardDescription>
              Refine your search to find the perfect volunteer opportunities
            </CardDescription>
          </div>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button
                ...
                onClick={() =>
                  setFilters((prev) => ({
                    ...prev,
                    weekendsOnly: !prev.weekendsOnly,
                  }))
                }
                className="h-8"
              >
              ...
              <Button
                ...
                onClick={() =>
                  setFilters((prev) => ({
                    ...prev,
                    recurringOnly: !prev.recurringOnly,
                  }))
                }
                className="h-8"
              >
                ...
                {skills.map((skill) => (
                  <div key={skill} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={() =>
                        handleArrayToggle(filters.skills, skill, "skills")
                      }
                    />
                ...
                {timeOfDayOptions.map((time) => (
                  <div key={time} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={() =>
                        handleArrayToggle(filters.timeOfDay, time, "timeOfDay")
                      }
                    />
          ...
          <div>
            <Label className="text-base font-medium mb-3 block">
              ...
              Volunteers Needed: {filters.volunteerCount[0]} -{" "}
              {filters.volunteerCount[1]}
            </Label>
            <Slider
              value={filters.volunteerCount}
              onValueChange={(value) =>
                setFilters((prev) => ({ ...prev, volunteerCount: value }))
              }
              max={100}
              min={1}
              step={1}
                ...
                {benefits.map((benefit) => (
                  <div key={benefit} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={() =>
                        handleArrayToggle(filters.benefits, benefit, "benefits")
                      }
                    />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setFilters((prev) => ({
                      ...prev,
                      backgroundCheckRequired: checked as boolean,
                    }))
                  }
                />
              ...
              <div className="flex flex-wrap gap-2">
                {filters.categories.map((cat) => (
                  <Badge
                    ...
                    onClick={() =>
                      handleArrayToggle(filters.categories, cat, "categories")
                    }
                  >
