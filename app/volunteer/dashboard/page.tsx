...
const mockOpportunities = [
  ...
  },
  {
    ...
    description: "Join us for a morning of beach cleanup and environmental education.",
    image: "/placeholder.svg?height=200&width=300",
  },
  {
    id: 3,
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Ready to make a difference today? You're doing amazing work!</p>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{currentMonthHours}h</p>
                  <div className="mt-2">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Your latest volunteer activities and updates</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500">
                            Your application for Animal Shelter Helper was approved
                          </p>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500">3 new opportunities match your skills</p>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium">Volunteer hours logged</p>
                          <p className="text-xs text-gray-500">4 hours added to your profile</p>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Opportunities that match your skills and interests</CardDescription>
                  </CardHeader>
                  <CardContent>
                      ...
                      {mockApplications.slice(0, 3).map((application) => (
                        <div key={application.id} className="flex items-center justify-between">
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-500">{application.organization}</p>
                          </div>
                          <Badge
                            variant={
          ...
          <TabsContent value="opportunities" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Discover volunteer opportunities that match your interests</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="applications" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Track all your volunteer applications</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-indigo-600">{application.organization}</p>
                            <p className="text-xs text-gray-500 mt-1">
                              Applied: {application.appliedDate} • Event: {application.eventDate}
                            </p>
